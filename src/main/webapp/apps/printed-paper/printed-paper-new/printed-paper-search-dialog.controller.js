(function() {
    ...
    angular
        .module('app')
        .controller('PrintedPaperSearchDialogController', PrintedPaperSearchDialogController);

    PrintedPaperSearchDialogController.$inject = ['$scope', '$controller', 'Principal'
    	, '$state', '$rootScope', 'PrintedPaperService'];

    function PrintedPaperSearchDialogController ($scope, $controller, Principal
    		, $state, $rootScope, PrintedPaperService) {
    	var vm = this;
