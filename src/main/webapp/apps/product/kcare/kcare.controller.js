(function() {
    ...
    ProductKcareController.$inject = ['$scope', '$controller', 'ProductKcareService', '$state', '$rootScope'];

    function ProductKcareController ($scope, $controller, ProductKcareService, $state, $rootScope) {
        var vm = this;
    	...
    	// Init controller
  		...
  		function init() {
  			// Load car branches
  			ProductKcareService.getCarBranches({}, getCarBranchesSuccess, getCarBranchesError);
  		}
    	...
    	function createNewPolicy() {
    		var postData = getPostData(true);
	  		...
	  		ProductKcareService.createNewPolicy(vm.policy, onCreatePolicySuccess, onCreatePolicyError);
    	}
